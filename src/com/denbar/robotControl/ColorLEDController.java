...
import com.denbar.robotControl.Slider.SliderPositionListener;
...
public class ColorLEDController {
	...
	class LedValueUpdater implements Slider.SliderPositionListener {
		...
		public void onPositionChange(double value) {
			...
			if (mActivity != null) {
				mActivity.sendCommand(RobotControlActivity.LED_SERVO_COMMAND,
	...
	public ColorLEDController(RobotControlActivity activity, int number,
